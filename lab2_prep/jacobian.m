...
J=zeros(6,6); % define zero matrix
...
% extract rotation matrix and translation vector from H using tr2rt()
H00 = [0,0,1];O00 = [0,0,0]; %
...
% presumption: all joints are revolute so assign the z-components
J(4:6,1)=H00; Z00 = H00; 
...
O00 = O00.*0.01;% disp (O00);
O01 = O01.*0.01; %disp (O01);
O02 = O02.*0.01; %disp (O02);
O03 = O03.*0.01; %disp (O03);
O04 = O04.*0.01; %disp (O04);
O05 = O05.*0.01; %disp (O05);
O06 = O06.*0.01; %disp (O06);

% presumption: all joints are revolute so assign the cross products
